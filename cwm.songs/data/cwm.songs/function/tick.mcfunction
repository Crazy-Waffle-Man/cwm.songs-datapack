#Souls
execute as @a[tag=cwm.slime_core] run function cwm.songs:souls_running/slime/main
execute as @a[tag=cwm.infested] run function cwm.songs:souls_running/infested/main
execute as @a[tag=cwm.stone_paladin] run function cwm.songs:souls_running/stone_paladin/main
